 ...
 <div class="row">
        ...
        <form action="<?=base_url()?>admin/Datapelanggan/TambahDataPelanggan" method="post" enctype="multipart/form-data">
...
<br>
    ...
    <tr>
      ...
      <td><a href="<?php echo base_url()."admin/datapelanggan/editdatapelanggan/$data->id"; ?>"><button type="button" class="btn btn-success">Edit</button></a>
