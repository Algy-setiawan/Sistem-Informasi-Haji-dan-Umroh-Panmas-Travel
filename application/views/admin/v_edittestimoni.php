 ...
 <div class="row">
      ...
      <?php foreach ($testimoni as $data) ?>
        <form action="<?=base_url()?>admin/Testimoni/UpdateTestimoni" method="post" enctype="multipart/form-data">
...
echo date(" d F Y ");?>">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama" name="nama" value="<?php echo $data->nama ?>"  required><br>
