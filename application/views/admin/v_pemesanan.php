 ...
 <div class="row">
        ...
        <form action="<?=base_url()?>admin/Pemesanan/TambahPemesanan" method="post" enctype="multipart/form-data">

           <div class="form-group">
            <label for="exampleInputEmail1">Nama Pelanggan</label>
                  <select name="nama" class="form-control"  required>
                    <option value="" hidden="">Pilih Nama Pelanggan</option>
...
echo date(" d F Y ");?>" readonly required><br>
          ...
          <div class="box">
           ...
           <table class="table table-bordered table-striped table-hover">
                <tr>
                  ...
                  <th style="width: 200px">Tanggal Kebrangkatan</th>
    ...
    <tr>
      ...
      <td><a href="<?php echo base_url()."admin/pemesanan/editpemesanan/$data->id_pemesanan"; ?>"><button type="button" class="btn btn-success">Edit</button></a>
      <a href="<?php echo base_url()."admin/pemesanan/hapuspemesanan/$data->id_pemesanan"; ?>" onclick="return confirm ('Yakin Mau Di Hapus ?')"><button type="button" class="btn btn-danger" id="demo">Hapus</button></a></td>
    </tr>
    <?php endforeach ?>
